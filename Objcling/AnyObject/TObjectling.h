 ...
 */
@property (readonly) TObjectling *(^appendto)(id dst);
/**
 * 增量功能的抽象
 * 将对象作为被拼接的内容追加到其他内容，有拼接字符串，添加集合内容，子视图的增加
 */
@property (readonly) TObjectling *(^appendtoAt)(id dst, NSUInteger idx);
 ...
 */
@property (readonly) TObjectling *(^deleteFrom)(id dst);
/**
 * 减量功能的抽象
 * 集合的清空，字符串的清空
 * 注：如果必要则会潜在的把target提升为可变类型
...
@property (readonly) TObjectling *(^kvcOuter)(id forObj,NSString *forKey);
