#
#  Be sure to run `pod spec lint LinkBlock.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Novo"
  # s.authors            = { "Novo" => "quxingyi@outlook.com" }
  # s.social_media_url   = "http://twitter.com/Novo"
  ...
  s.source_files  = "LinkBlockProgram", "LinkBlockProgram/LinkBlock/*.{h,m}"
