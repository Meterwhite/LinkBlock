...
/** 对数字敏感の比较两个字符串：12.3 < 12.4; Foo2.txt < Foo7.txt ; */
@property (nonatomic,copy) NSComparisonResult (^blockCompareStrNumberSuper)(NSString* str1 , NSString* str2);
...
/** 分割字符串 */
@property (nonatomic,copy) NSArray*     (^blockSplitStrWithStrs)(NSArray* splitStrs);

#pragma mrak - convert（转换
/** 0xcccccc or #cccccc or cccccc */
@property (nonatomic,copy) UIColor*             (^blockToColorFromHexStr)(NSString* hexStr);
